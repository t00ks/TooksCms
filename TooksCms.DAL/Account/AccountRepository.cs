...
namespace TooksCms.DAL
{
    public class AccountRepository : IAccountRepository
    {
        ...
        private bool _userExists(int id, TooksCmsDAL db)
        {
            return db.Users.Any(u_ => u_.UserId == id);
        }

        private bool _userExists(string loginName, TooksCmsDAL db)
        {
        ...
        private bool _contactExists(int id, TooksCmsDAL db)
        {
            return db.ContactInfoes.Any(c_ => c_.ContactInfoId == id);
        }

        private bool _contactExistsOnUserId(int id, TooksCmsDAL db)
        {
        ...
        private bool _addressExists(int id, TooksCmsDAL db)
        {
        ...
        private bool _phoneNumberExists(int id, TooksCmsDAL db)
        {
        ...
        private bool _emailExists(int id, TooksCmsDAL db)
        {
        ...
        private bool _guestExists(int id, TooksCmsDAL db)
        {
            return db.Guests.Any(g_ => g_.GuestId == id);
        }

        private bool _guestExists(string ipAddress, TooksCmsDAL db)
        {
